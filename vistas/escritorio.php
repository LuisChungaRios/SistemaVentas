...
//   Total ventas
  $rsptav = $consulta->total_ventas();
  $regv=$rsptav->fetch_object();
  $totalv=$regv->total_venta;
  
//Total productos
$rsptap = $consulta->total_productos();
$regp=$rsptap->fetch_object();
$totalp=$regp->total_productos;

//Total Cliente
$rsptac = $consulta->total_clientes();
$regc=$rsptac->fetch_object();
$totalc=$regc->total_clientes;


//Total Categorias
$rsptaca = $consulta->total_categorias();
$regca=$rsptaca->fetch_object();
$totalca=$regca->total_categorias;

    //Productos recientes
$rsptapror = $consulta->productos_recientes();
$regpror=$rsptapror->fetch_assoc();
// $totalca=$regca->total_categorias;
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                          <div class="small-box bg-blue">
                              ...
                              <a href="categoria.php" class="small-box-footer">Categorias <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
