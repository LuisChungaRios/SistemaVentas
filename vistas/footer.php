<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">ITEncode</a>.</strong> Todos los derechos reservados.
</footer>
<!-- jQuery 2.1.4 -->
...
<script type="text/javascript" src="../public/js/bootbox.min.js">

</script>
<script type="text/javascript" src="../public/js/bootstrap-select.min.js">
